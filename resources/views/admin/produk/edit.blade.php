                    ...
                    <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="ukuran_kemasan" name="ukuran_kemasan" value="{{ old('ukuran_kemasan', $produk->ukuran_kemasan) }}" placeholder="Contoh: 500 gram, 1 Liter, Botol Kecil">
                            </div>
                        </div>
