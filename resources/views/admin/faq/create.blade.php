        ...
        <div class="col-lg-8">
            <div class="card card-custom border-0 shadow-sm">
                <div class="card-header bg-white border-0 py-3">
                    <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-question-circle-fill me-2 text-primary-custom"></i>Form Tambah FAQ</h6>
                </div>
                    ...
                    <form action="{{ route('admin.faq.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="jawaban" id="jawaban" rows="5"
                                      ...
                                      placeholder="Tuliskan jawaban yang jelas dan informatif...">{{ old('jawaban') }}</textarea>
